...
- Main package: higher level task-dispatches, control flow integration
	- `distro` module: holds multiple distro-specific modules
		...
		- `post_install` module: Implements the post_install procedure. Post install includes cleanups (removing D-Bus services, etc.), and file installing (desktop file, D-Bus services etc.). Distro specific modules implements various traits defined in traits module.